...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/sly.min.js":[function(require,module,exports) {
...
!function (a, b, c) {
  ...
  function d(b, p, q) {
    function K(c) {
      ...
      if (!sb.initialized) {
        sb.on(q);var a = ["overflow", "position"],
    ...
    var f, g;return a.isPlainObject(b) || (("string" === e(b) || b === !1) && (f = b === !1 ? "destroy" : b, g = Array.prototype.slice.call(arguments, 1)), b = {}), this.each(function (e, h) {
      var i = a.data(h, r);i || f ? i && f && i[f] && i[f].apply(i, g) : i = a.data(h, r, new d(h, b, c).init());
    });
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/sly.min.js"], null)
//# sourceMappingURL=/sly.min.3a31efc5.map