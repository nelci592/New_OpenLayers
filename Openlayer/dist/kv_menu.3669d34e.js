...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"script/kv_menu.js":[function(require,module,exports) {
jQuery(function ($) {
  'use strict';
  ...
  **/
  ...
  (function () {
    ...
    var $wrap = $frame.parent(); // Call Sly on frame
    ...
    $wrap.find('.toCenter').on('click', function () {
      var item = $(this).data('item'); // Animate a particular item to the center of the frame.
      // If no item is provided, the whole content will be animated.
    ...
    $wrap.find('.toEnd').on('click', function () {
      var item = $(this).data('item'); // Animate a particular item to the end of the frame.
      // If no item is provided, the whole content will be animated.
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","script/kv_menu.js"], null)
//# sourceMappingURL=/kv_menu.3669d34e.map