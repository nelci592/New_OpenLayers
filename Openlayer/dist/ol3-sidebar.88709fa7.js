...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"sidebar/js/ol3-sidebar.js":[function(require,module,exports) {
ol.control.Sidebar = function (settings) {
    ...
    for (i = this.element.children.length - 1; i >= 0; i--) {
        ...
        if (child.tagName === 'DIV' && child.classList.contains('sidebar-content')) {
...
ol.control.Sidebar.prototype.open = function (id) {
    ...
    for (i = this._panes.length - 1; i >= 0; i--) {
        child = this._panes[i];
        if (child.id == id) child.classList.add('active');else if (child.classList.contains('active')) child.classList.remove('active');
    }

    // remove old active highlights and set new highlight
    for (i = this._tabitems.length - 1; i >= 0; i--) {
        child = this._tabitems[i];
        if (child.querySelector('a').hash == '#' + id) child.classList.add('active');else if (child.classList.contains('active')) child.classList.remove('active');
    }
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","sidebar/js/ol3-sidebar.js"], null)
//# sourceMappingURL=/ol3-sidebar.88709fa7.map