...
(0, _jquery2.default)(function () {
    ...
    function parseMenu(ul, menu) {
        for (var i = 0; i < menu.length; i++) {
            ...
            if (menu[i].sub != null) {
                var subul = (0, _jquery2.default)('<ul class="submenu" id="submenu' + menu[i].link + '"></ul>');
                (0, _jquery2.default)(li).append(subul);
                parseMenu((0, _jquery2.default)(subul), menu[i].sub);
            }
        }
    }
...
//# sourceMappingURL=/OPenlayer.23d70975.map